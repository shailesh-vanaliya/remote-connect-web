...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Edit DeviceMap #{{ $devicemap->id }}</div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/admin/device-map/' . $devicemap->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            {{ csrf_field() }}

                            @include ('admin.device-map.form', ['formMode' => 'edit'])
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Edit DeviceMap #{{ $devicemap->id }}</h3>
