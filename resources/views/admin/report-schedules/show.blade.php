                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <tbody>
                                <tr>
                                    <th> Report Id </th>
                                    <td> {{ $reportschedule->report_id }} </td>
                                </tr>
                                <tr>
                                    <th> Start Time </th>
                                    <td> {{ $reportschedule->start_time }} </td>
                                </tr>
                                <tr>
                                    <th> End Time </th>
                                    <td> {{ $reportschedule->end_time }} </td>
                                </tr>
                                <tr>
                                    <th> Execution Time </th>
                                    <td> {{ $reportschedule->execution_time }} </td>
                                </tr>
                                <tr>
                                    <th> Repeat On </th>
                                    @php
                                        $array = json_decode($reportschedule->repeat_on);
                                    @endphp
                                    <td> {{ implode(', ',$array) }} </td>
                                </tr>
                                <tr>
                                    <th> Sernder User List </th>
                                    <td> {{ $reportschedule->sender_user_list }} </td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
