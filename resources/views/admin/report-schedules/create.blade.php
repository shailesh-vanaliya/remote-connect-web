...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Create New ReportSchedule</div>
                    <div class="card-body">
...
@endif
<form method="POST" action="{{ url('/admin/report-schedules') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
    {{ csrf_field() }}
    @include ('admin.report-schedules.form', ['formMode' => 'create'])
</form>
</div>
</div>
</div>
            ...
            <div class="col-md-12">
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title">Create New ReportSchedule</h3>
