                ...
                <div class="box-body">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                             <tbody>
                                    <tr>
                                        <th>ID</th><td>{{ $reportconfiguration->id }}</td>
                                    </tr>
                                    <tr><th> Report Id </th><td> {{ $reportconfiguration->report_id }} </td></tr><tr><th> Device Id </th><td> {{ $reportconfiguration->device_id }} </td></tr><tr><th> Organization Id </th><td> {{ $reportconfiguration->organization_id }} </td></tr><tr><th> Report Title </th><td> {{ $reportconfiguration->report_title }} </td></tr><tr><th> Parameter </th><td> {{ $reportconfiguration->parameter }} </td></tr>
                                </tbody>
                        </table>
                    </div>
                </div>
