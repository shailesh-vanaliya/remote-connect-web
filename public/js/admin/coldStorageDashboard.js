var ColdStorageDashboard = function () {
    var handleList = function () {
        ...
        function getAmChart() {
            ...
            $.ajax({
                ...
                url: site_url + "admin/cold-storage/ajaxAction",
                data: { 'action': 'getColdChartData', 'endDate': endDate, 'startDate': startDate, 'dateRange': dateRange, "modem_id": modem_id },
